...
which_gba_title = sys.argv[1] # 'fe6', 'fe7', or 'fe8'

if which_gba_title != 'fe6' and which_gba_title != 'fe7' and which_gba_title != 'fe8':
    sys.exit('Please provide one of the following strings as input: "fe6", "fe7", "fe8')
